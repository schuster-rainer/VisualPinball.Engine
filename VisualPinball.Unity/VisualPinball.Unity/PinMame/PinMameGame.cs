...
namespace VisualPinball.Unity.PinMame
{
	public class PinMameGame
	{
		...
		public GamelogicEngineCoil[] AvailableCoils { get; } = {
			new GamelogicEngineCoil { Id = "01", Description = "Auto Plunger" },
			new GamelogicEngineCoil { Id = "02", Description = "Trough Eject", DeviceHint = "^Trough\\s*\\d?", DeviceItemHint = Trough.EjectCoilId },
			new GamelogicEngineCoil { Id = "03", Description = "Left Popper" },
			new GamelogicEngineCoil { Id = "04", Description = "Castle" },
			new GamelogicEngineCoil { Id = "05", Description = "Castle Gate (power)" },
			new GamelogicEngineCoil { Id = "06", Description = "Castle Gate (hold)", MainCoilIdOfHoldCoil = "05" },
			new GamelogicEngineCoil { Id = "07", Description = "Knocker" },
			new GamelogicEngineCoil { Id = "08", Description = "Catapult" },
			new GamelogicEngineCoil { Id = "09", Description = "Right Eject" },
			new GamelogicEngineCoil { Id = "10", Description = "Left Slingshot" },
			new GamelogicEngineCoil { Id = "11", Description = "Right Slingshot" },
			new GamelogicEngineCoil { Id = "12", Description = "Left Jet Bumper" },
			new GamelogicEngineCoil { Id = "13", Description = "Bottom Jet Bumper" },
			new GamelogicEngineCoil { Id = "14", Description = "Right Jet Bumper" },
			new GamelogicEngineCoil { Id = "15", Description = "Tower Diverter (power)" },
			new GamelogicEngineCoil { Id = "16", Description = "Tower Diverter (hold)", MainCoilIdOfHoldCoil = "15" },
			new GamelogicEngineCoil { Id = "17", Description = "Left Side Low Flashers" },
			new GamelogicEngineCoil { Id = "18", Description = "Left Ramp Flashers" },
			new GamelogicEngineCoil { Id = "19", Description = "Left Side High Flashers" },
			new GamelogicEngineCoil { Id = "20", Description = "Right Side High Flashers" },
			new GamelogicEngineCoil { Id = "21", Description = "Right Ramp Flashers" },
			new GamelogicEngineCoil { Id = "22", Description = "Castle Right Side Flashers" },
			new GamelogicEngineCoil { Id = "23", Description = "Right Side Low Flashers" },
			new GamelogicEngineCoil { Id = "24", Description = "Moat Flashers" },
			new GamelogicEngineCoil { Id = "25", Description = "Castle Left Side Flashers" },
			new GamelogicEngineCoil { Id = "26", Description = "Tower Lock Post" },
			new GamelogicEngineCoil { Id = "27", Description = "Right Gate" },
			new GamelogicEngineCoil { Id = "28", Description = "Left Gate" },
			new GamelogicEngineCoil { Id = "29", Description = "Lower Right Flipper (power)", PlayfieldItemHint = "^(RightFlipper|RFlipper|FlipperRight|FlipperR)$" },
			new GamelogicEngineCoil { Id = "30", Description = "Lower Right Flipper (hold)", MainCoilIdOfHoldCoil = "29" },
			new GamelogicEngineCoil { Id = "31", Description = "Lower Left Flipper (power)", PlayfieldItemHint = "^(LeftFlipper|LFlipper|FlipperLeft|FlipperL)$" },
			new GamelogicEngineCoil { Id = "32", Description = "Lower Left Flipper (hold)", MainCoilIdOfHoldCoil = "31" },
			new GamelogicEngineCoil { Id = "33", Description = "Left Troll (power)" },
			new GamelogicEngineCoil { Id = "34", Description = "Left Troll (hold)", MainCoilIdOfHoldCoil = "33" },
			new GamelogicEngineCoil { Id = "35", Description = "Right Troll (power)" },
			new GamelogicEngineCoil { Id = "36", Description = "Right Troll (hold)", MainCoilIdOfHoldCoil = "35" },
		};
